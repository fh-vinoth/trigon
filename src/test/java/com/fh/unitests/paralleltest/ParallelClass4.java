...
public class ParallelClass4 extends TestController {
    ...
    public void parallelClass4_Method1() {
        ...
        testStatus("PASS", "parallelClass4_Method1 PASSED1");
    ...
    public void parallelClass4_parallelMethod1_SubMethod() {
        ...
        testStatus("PASS", "parallelClass4_parallelMethod1_SubMethod PASSED1");
    }
    ...
    public void parallelClass4_Method2() {
        ...
        testStatus("PASS", "parallelClass4_Method2 PASSED1");
        testStatus("FAIL", "parallelClass4_Method2 FAILED1");
        testStatus("PASS", "parallelClass4_Method2 PASSED2");
        testStatus("FAIL", "parallelClass4_Method2 FAILED2");
    ...
    public void parallelClass4_parallelMethod2_SubMethod() {
        ...
        testStatus("FAIL", "parallelClass4_parallelMethod2_SubMethod FAILED1");
        testStatus("FAIL", "parallelClass4_parallelMethod2_SubMethod FAILED2");
        testStatus("PASS", "parallelClass4_parallelMethod2_SubMethod PASSED1");
        testStatus("PASS", "parallelClass4_parallelMethod2_SubMethod PASSED2");
    }
    ...
    public void parallelClass4_Method3(LinkedHashMap<String, Object> map) {
        ...
        testStatus("PASS", "parallelClass4_Method3 PASSED1");
        testStatus("PASS", "parallelClass4_Method3 PASSED2");
        testStatus("PASS", "parallelClass4_Method3 PASSED3");
    ...
    public void parallelClass4_parallelMethod3_SubMethod() {
        ...
        testStatus("PASS", "parallelClass4_parallelMethod3_SubMethod PASSED1");
        testStatus("PASS", "parallelClass4_parallelMethod3_SubMethod PASSED2");
        testStatus("PASS", "parallelClass4_parallelMethod3_SubMethod PASSED3");
    }
    ...
    public void parallelClass4_Method4() {
        ...
        testStatus("PASS", "parallelClass4_Method4 PASSED1");
        testStatus("FAIL", "parallelClass4_Method4 FAILED1");
        testStatus("FAIL", "parallelClass4_Method4 FAILED2");
        testStatus("PASS", "parallelClass4_Method4 PASSED2");
    ...
    public void parallelClass4_parallelMethod4_SubMethod() {
        ...
        testStatus("PASS", "parallelClass4_parallelMethod4_SubMethod PASSED1");
        testStatus("FAIL", "parallelClass4_parallelMethod4_SubMethod FAILED1");
        testStatus("FAIL", "parallelClass4_parallelMethod4_SubMethod FAILED2");
        testStatus("PASS", "parallelClass4_parallelMethod4_SubMethod PASSED2");
    }
}
