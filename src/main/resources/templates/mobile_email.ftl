...
<head>
    <meta charset="UTF-8">
    <title>FH Mobile Automation Summary Report</title>
</head>
                ...
                <table style="width: 100%;border-radius: 10px;background: #314e4e;overflow: hidden;border-collapse: collapse;">
                    <tr>
                        <td colspan="5" style="height: 50px;text-align: center">
                            <div style="font-size: 15px">Mobile Test Suite :${testSuiteName}</div>
                        </td>
                    </tr>
                        ...
                        <tr>
                            <td colspan="5" style="background: #5f6961d9;text-align: center; text-justify: inter-word;">
                                ...
                                <div>
                                    ...
                                    ${tmoduleData.testAndroidDevice!}|
                                    ${tmoduleData.testAndroidVersion!}|
                                    ${tmoduleData.testAndroidBuildNumber!}|
                                    ${tmoduleData.testIosDevice!}|
                                    ${tmoduleData.testIosVersion!}|
                                    ${tmoduleData.testIosBuildNumber!}
                                </div>
                            </td>
                        </tr>
