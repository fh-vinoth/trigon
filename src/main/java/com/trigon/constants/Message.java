...
public class Message {
    public static final String NAVIGATED_TO_PAGE = "Navigated to Page : ";
    ...
    public static final String CLICKED = " and clicked on the Button : ";
    public static final String ELEMENT_NOT_INTRACTABLE = " and element is Visible, but it is NOT intractable ";
    public static final String ELEMENT_NOT_INTRACTABLE_CLICK = ELEMENT_NOT_INTRACTABLE + "or NOT Clickable ";
    public static final String GET_ATTRIBUTE = "and captured the Attribute For : ";
    public static final String ELEMENT_NOT_INTRACTABLE_GET_ATTRIBUTE = ELEMENT_NOT_INTRACTABLE + "to capture Attribute ";
    public static final String ELEMENT_VERIFY_DISPLAYED = "and verified that element is Displayed : ";
    public static final String ELEMENT_NOT_INTRACTABLE_VERIFY_DISPLAYED = ELEMENT_NOT_INTRACTABLE + "to check element displayed ";
    public static final String CLEAR_TEXT = "and cleared the Text : ";
